...
public class WeatherWebservice extends AsyncTask<Void, Void, ArrayList<Weather>> {
    ...
    //	private final String API_KEY = "5d2eef1e303470228dcf653b4f989499";
    private final String API_KEY = "d5dbacad7d2873f18ab91deb9319b6cc";

    private FragmentCallback mFragmentCallback;
    String apiUrlIcon = "http://openweathermap.org/img/w/";
    String apiUrlFormat = "http://api.openweathermap.org/data/2.1/find/city?&lat=%f&lon=%f&cnt=1&APPID=" + API_KEY;
    String apiForecastUrlFormat = "http://api.openweathermap.org/data/2.5/forecast/daily?&lat=%f&lon=%f&APPID=" + API_KEY;
    String apiSearchCityFormat = "http://api.openweathermap.org/data/2.5/weather?q=%s&APPID=" + API_KEY;
    String apiUrl;
    Location location;
